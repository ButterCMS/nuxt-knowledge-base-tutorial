...
## Important Note
This project was created as an example use case of ButterCMS in conjunction with a blog article, [Nuxt Tutorial: Building a Knowledge Base Powered by ButterCMS](https://buttercms.com/blog/nuxt-tutorial-building-a-knowledge-base/), and will not be actively maintained.
...
- Check out our [API Docs](https://buttercms.com/docs/api/#introduction)
